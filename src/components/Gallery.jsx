  ...
  return (
    <section id="gallery" className="section" style={{ position: 'relative' }}>
      <div className="container">
        ...
        {/* Gallery Grid */}
        {loading ? (
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '200px', marginTop: '3rem' }}>
            <motion.div 
              animate={{ rotate: 360 }} 
          ...
          <div className="glass-card" style={{ padding: '3rem', textAlign: 'center', color: 'var(--text-secondary)', marginTop: '3rem', maxWidth: '600px', marginInline: 'auto' }}>
            <Image size={48} style={{ margin: '0 auto 1rem auto', opacity: 0.5, display: 'block', color: 'var(--color-primary)' }} />
            <p style={{ fontWeight: '500', fontSize: '1.1rem' }}>No moments captured yet</p>
            <p style={{ fontSize: '0.85rem', marginTop: '0.25rem' }}>Check back later for photos of E-Cell events and activities!</p>
          </div>
        ) : (
